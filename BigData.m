...
% Her fastsættes øvre og nedre grænser for hvad der er normalt for de
...
% Vælger hvilken patient vi vil se data fra.
...
hold off
%% 
% Samme kode bliver brugt til at finde værdierne over og under grænserne for de andre målinger.
% På samme måde som med heart rate findes og plottes alle værdier.
...
% Normalisere vores værdier for de enkelte vital signs
normHR = normalize(HR);
normRR = normalize(RR);
